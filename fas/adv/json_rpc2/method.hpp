#ifndef FAS_ADV_JSON_RPC2_METHOD_HPP
#define FAS_ADV_JSON_RPC2_METHOD_HPP
...
public:
  ...
  typedef typename amj::serializer<invoke_request_rpc> invoke_request_serializer;
  typedef typename amj::serializer<invoke_response_rpc> invoke_response_serializer;
...
public:
  ...
  typedef typename amj::serializer<call_request_rpc> call_request_serializer;
  typedef typename amj::serializer<call_response_rpc> call_response_serializer;
  ...
  template<typename T>
  void request ( T& t, const call_request_type& param)
  {
...
public:
  ...
  // remote call
  template<typename T, typename P>
  void request ( T& t, const P& param)
  {
    caller_base::request(t, param);
  }
